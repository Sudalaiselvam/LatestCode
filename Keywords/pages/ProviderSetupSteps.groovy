...
public class ProviderSetupSteps {
	...
	private static final String editProvider='editProvider'
	...
	public static void gotoProviderSetup() {
		...
		getBaseSteps().waitForControlDisplay('mnuProvider', 20,pageName.Header)
...
getBaseSteps().setWindowsSize(75)
	...
	public static void clickCreateProvider() {
		getBaseSteps().waitForControlDisplay(btnCreateProvider, pageName.ProviderSetup)
	...
	public static void clickEdit() {
		getBaseSteps().clickToControl(editProvider, pageName.ProviderSetup)
		getBaseSteps().waitforLoadingComplete('imgLoading', pageName.CMN)
	}
	
	public static getPhysicianHireDate(String Provider) {
		
				String HireDate, EmployeeStatus
		
				setProviderSearch(Provider)
				clickEdit()
				EmployeeStatus=getEmployeeStatusDropDownValue()
				HireDate=getBaseSteps().getValueFromControl(txtHireDate, pageName.ProviderSetup)
		
				println(HireDate)
				println(EmployeeStatus)
