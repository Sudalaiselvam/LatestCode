...
public class HIIConstants {
	...
	public static final String ErrorDetailsExcelName='EMRDetails.xlsx'
	...
	public static List<String> ProviderEMRDataDetailsGridColumnHeadings(){
		List<String> gridHeadings=new ArrayList<String>()
		gridHeadings.add('Year')
		gridHeadings.add('Month')
		gridHeadings.add('Payroll ID')
		gridHeadings.add('EMR ID')
		gridHeadings.add('Provider Name')
		gridHeadings.add('Cost Center')
		gridHeadings.add('Charges')
		gridHeadings.add('Payments')
		gridHeadings.add('wRVUs')
		gridHeadings.add('wRVUs Adjs')
		gridHeadings.add('Details')
		return gridHeadings
	}


	public static final String expEMRDataPopupTitle='CPT Code Data Details'

	public static final String ProviderEMRProcessedSuccessMessage='Processed EMR Exported successfully'
	public static final String ProviderEMRProcessedExportExcelName='Processed_EmrFile.xlsx'
	public static final String ProviderEMROriginalSuccessMessage='Original EMR Exported successfully'
	public static final String ProviderEMROriginalExportExcelName='Original_EmrFile.xlsx'
	public static final String MissingProviderSuccessMessage='Missing Providers downloaded successfully'
	public static final String MissingProviderDownloadExcelName='MissingPhysicians.xlsx'
	public static final String MissingContractSuccessMessage='Missing Providers downloaded successfully'
	public static final String MissingContractDownloadExcelName='MissingContract.xlsx'
	public static final String MissingCostCenterSuccessMessage='Missing Providers downloaded successfully'
	public static final String MissingCostCenterDownloadExcelName='MissingCostCenter.xlsx'
	public static final String ErrorRecordsExcelName='ErrorRecords.xlsx'


	public static final String RIJ_expSuccessMSG='Job Executed Successfully. Please check your Mail'
	public static final String RIJ_expErrorMSG='Job Execution Failed. Please check your Mail'

	public static List<String> ProviderEMRFileColumnHeader(){
		List<String> ExcEMRFileHeader=new ArrayList<String>()
		ExcEMRFileHeader.add('TX_ID')
		ExcEMRFileHeader.add('COST_CENTER_CODE')
		ExcEMRFileHeader.add('COST_CENTER_NAME')
		ExcEMRFileHeader.add('COST_CENTER_CLINIC_TYPE')
		ExcEMRFileHeader.add('PROCEDURE_CATEGORY_ID')
		ExcEMRFileHeader.add('PROCEDURE_CATEGORY_NAME')
		ExcEMRFileHeader.add('GL_COMPANY_UNIT')
		ExcEMRFileHeader.add('CATEGORY_TYPE')
		ExcEMRFileHeader.add('CHARGE_TYPE')
		ExcEMRFileHeader.add('ENCOUNTER_TYPE')
		ExcEMRFileHeader.add('POS_CODE')
		ExcEMRFileHeader.add('POS_CODE_TYPE')
		ExcEMRFileHeader.add('Performing_Provider_Name')
		ExcEMRFileHeader.add('Performing_Provider_NPI')
		ExcEMRFileHeader.add('Performing_Provider_EID')
		ExcEMRFileHeader.add('PERFORMING_PROVIDER_EMRID')
		ExcEMRFileHeader.add('Performing_Provider_Type')
		ExcEMRFileHeader.add('Performing_Provider_Credentials')
		ExcEMRFileHeader.add('PERFORMING_PROVIDER_GROUP_NAME')
		ExcEMRFileHeader.add('PERFORMING_PROVIDER_GROUP_CODE')
		ExcEMRFileHeader.add('Billing_Provider_Name')
		ExcEMRFileHeader.add('Billing_Provider_NPI')
		ExcEMRFileHeader.add('Billing_Provider_EID')
		ExcEMRFileHeader.add('Billing_PROVIDER_EMRID')
		ExcEMRFileHeader.add('Billing_PROVIDER_GROUP_NAME')
		ExcEMRFileHeader.add('Billing_PROVIDER_GROUP_CODE')
		ExcEMRFileHeader.add('Supervising_Provider_Name')
		ExcEMRFileHeader.add('Supervising_Provider_NPI')
		ExcEMRFileHeader.add('Supervising_Provider_EID')
		ExcEMRFileHeader.add('Supervising_PROVIDER_EMRID')
		ExcEMRFileHeader.add('Supervising_Provider_Credentials')
		ExcEMRFileHeader.add('Supervising_PROVIDER_GROUP_NAME')
		ExcEMRFileHeader.add('Supervising_PROVIDER_GROUP_CODE')
		ExcEMRFileHeader.add('Service_Date')
		ExcEMRFileHeader.add('Post_Date')
		ExcEMRFileHeader.add('Proc_Code')
		ExcEMRFileHeader.add('Proc_Description')
		ExcEMRFileHeader.add('MOD1')
		ExcEMRFileHeader.add('MOD2')
		ExcEMRFileHeader.add('MOD3')
		ExcEMRFileHeader.add('MOD4')
		ExcEMRFileHeader.add('MOD5')
		ExcEMRFileHeader.add('MOD6')
		ExcEMRFileHeader.add('PROC_QTY')
		ExcEMRFileHeader.add('Total_wRVUs')
		ExcEMRFileHeader.add('FACILITY_RVU')
		ExcEMRFileHeader.add('NONFACILITY_RVU')
		ExcEMRFileHeader.add('MALPRACTICE_RVU')
		ExcEMRFileHeader.add('Charge_amount')
		ExcEMRFileHeader.add('PT_MRN')
		ExcEMRFileHeader.add('PT_NAME')
		ExcEMRFileHeader.add('PT_CHARGE_NUM')
		ExcEMRFileHeader.add('PT_CHG_ACCT_NUM')
		ExcEMRFileHeader.add('PT_CHG_REVENUE_CENTER_CODE')
		ExcEMRFileHeader.add('PT_CHG_REVE')
		ExcEMRFileHeader.add('PAYMENTS')
		ExcEMRFileHeader.add('REFUNDS')
		ExcEMRFileHeader.add('ADJUSTMENTS')
		ExcEMRFileHeader.add('BAD_DEBT')
		ExcEMRFileHeader.add('FINANCIAL_CLASS')



		return ExcEMRFileHeader
	}

	public static final String lblEMRFileUploadType='EMR File Upload Type'
	public static final String expValidation = 'Record Updated Successfully.'

	public static final String lblDisplayOriginalEMRData='Display Original EMR Data'


	public static final String ProcessedwRVUSCalculationReportCsvName='wRVUs Calculation Report_Processed_All_0_2022.csv'
	public static final String ProcessedwRVUSCalculationReportSuccessMessage='Processed wRVUS Calculation Report downloaded successfully'
	public static final String OriginalwRVUSCalculationReportCsvName='wRVUs Calculation Report_Original_All_0_2022.csv'
	public static final String OriginalwRVUSCalculationReportSuccessMessage='Original wRVUS Calculation Report downloaded successfully'
	public static final String JobExecutedSuccessMessage='Job Executed Successfully. Please check your Mail'
	public static final String JobExecutedFailureMessage='Job Execution Failed. Please check your Mail'
	public static final String DuplicateRowError='Duplicate Row.'

	public static List<String> InterfaceLogSummaryGridHeader(){
		List<String> gridHeader=new ArrayList<String>()
		gridHeader.add('Interface')
		gridHeader.add('Input File Name')
		gridHeader.add('Processed Date')
		gridHeader.add('Job Status')
		gridHeader.add('Total Count')
		gridHeader.add('Created Records')
		gridHeader.add('Updated Records')
		//	gridHeader.add('Excluded Records')
		gridHeader.add('Error Records')
		//	gridHeader.add('LOA Warnings')
