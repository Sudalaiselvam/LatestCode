...
//RunInterfaceJobsPageSteps.VerifyJobExecutionStatus()

HeaderPageSteps.verifyNavigationToInterfaceLogSummary()

InterfaceLogSummaryPageSteps.VerifyFinalEMRFile(InputFileName, ProcessedDate)

HeaderPageSteps.verifyNavigationToProviderEMRData()

ProviderEMRDataPageSteps.VerifyDemoMethod1(InputFileName)