...
'Step 04: Verify Rounded for 3 decimals in Processed data'
ProviderEMRDataPageSteps.verifyProcessedTotalwRVUsCheckDeciaml()

'Step 05: Verify Rounded for 3 decimals in Original data'
ProviderEMRDataPageSteps.verifyOriginalTotalwRVUsCheckDeciaml()