...
import pages.MessageHistoryPageSteps
...
RunInterfaceJobsPageSteps.verifyJobExecutionStatusFail(JobName)

'Step 05: Navigate to Message History'
HeaderPageSteps.verifyNavigationToMessageHistory()

'Step 06: Veirfy Email received or not'
MessageHistoryPageSteps.verifyIsEmailReceived(To, Subject, SentOn, Message)
