...
'Step 04: Search provider which is available in uploaded EMR file'
ProviderEMRDataPageSteps.setProviderName(ProviderName)

'Step 04: Select Original'
ProviderEMRDataPageSteps.clickOriginal()


'Step 05: Export Original Excel'
ProviderEMRDataPageSteps.verifyOriginalExportwRVUstRVUscalculationReport()

'Step 06: Select Processed'
ProviderEMRDataPageSteps.clickProcessed()

'Step 07: Export Processed Excel'
ProviderEMRDataPageSteps.verifyProcessedExportwRVUstRVUscalculationReport()