...
LoginPageSteps.Login(GlobalVariable.USERNAME, GlobalVariable.PASSWORD, HIIConstants.ROLE_OrganizationAdmin)

'Step 03 :Navigate to Run Inter Job Page'
HeaderPageSteps.verifyNavigationToRunInterfaceJobs()

'Step 04: Run the Interface Job'
RunInterfaceJobsPageSteps.RunInterfaceJobs(JobName)
